                        ...
                        acc.push(
                            <div key={`log-${idx}`} className="ml-4">
                                ...
                                {(log.input_vertices !== null || log.output_vertices !== null) && (
                                    <div className="ml-2">Vertices: {log.input_vertices} → {log.output_vertices}</div>
                                )}

                                {(log.input_faces !== null || log.output_faces !== null) && (
                                    <div className="ml-2">Faces: {log.input_faces} → {log.output_faces}</div>
                                )}
